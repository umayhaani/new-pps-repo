...
const Maths5 = () => {
  ...
  const MathHandler1 = (e) => { 
    console.log(e.target.value ); 
    Math5valueeeee=e.target.value;
    console.log(Math5valueeeee);

    if (e.target.value === "Math5Chapter1Topic1" ){
      history.push("/Contents")}

    if   (e.target.value === "Math5Chapter1Topic2" ){
      history.push("/Contents")       
    }

    if   (e.target.value === "Math5Chapter1Topic3" ){
      history.push("/Contents")
    }
  ...
  const MathHandler2 = (e) => { 
    ...
    if (e.target.value === "Math5Chapter2Topic1" ){
      history.push("/Contents")}

    if   (e.target.value === "Math5Chapter2Topic2" ){
      history.push("/Contents")
    }  
  }; 
  ...
  return (
    <React.Fragment>
      <nav className="NavbarItems-math5">
      <NavLink to="/Student" >
                  
                  <img className="logo-math5" src={logo} alt="Logo" />
          
          </NavLink>
        <h1 className="navbar-logo-math5">{USERNAME}</h1>

        <ul className="nav-menu-math5 ">
        <div className="nav-links-math5">
                    <li>
                    <NavLink to="/Student" className="nav-links-math5">
                    Home
                    </NavLink>
                    </li>
                </div>
            ...
            <li>
              ...
              {/* </NavLink> */}
                ...
                <div className="nav-links-math5">
                    <li>
                    <NavLink to="/#" className="nav-links-math5">
                    Progress Report
                    </NavLink>
                    </li>
                </div>
                ...
                <div className="nav-links-math5">
                    <li>
                    <NavLink to="/Student/SpellBee" className="nav-links-math5">
                    Spell Bee
                    </NavLink>
                    </li>
                </div>
        </ul>
        <NavLink to="/#" > <button className="button-math5">Log out</button>
        </NavLink> 
        
      </nav>

      <div className="outerDiv-math5">
        <div className="all-divs-math5">

            <div className="body-div-math5"> 
              <select className="text-math5"  id="Chapter - 1"   
               onChange={MathHandler1 }>  
               
                <option value="MathGrade5Chapter1"> Chapter -1: Fractions  </option>  
                <option value="Math5Chapter1Topic1">1.1:  Fractions </option>  
                <option value="Math5Chapter1Topic2">1.2: Addition of fractions   </option>
            ...
            <div className="body-div-math5"> 
              <select className="text-math5"  id="Chapter - 2"    
               onChange={MathHandler2  } > 
{/* <br> </br>  */}
                <option value="MathGrade5Chapter2"> Chapter - 2:  HCF and LCM </option> 
                <option value="Math5Chapter2Topic1"  >2.1: H.C.F.    </option>  
                <option value="Math5Chapter2Topic2"  >2.2: L.C.M.   </option>   
              </select> 
            </div>
